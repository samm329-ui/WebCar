...
export const TEXT_SECTIONS: TextSection[] = [
  {
    ...
    className: 'top-[70%] left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full whitespace-nowrap',
  },
  {
    id: 2,
    start: 0.3,
    ...
    className: 'top-[70%] left-8 -translate-y-1/2 md:left-16',
  },
  {
    id: 3,
    start: 0.55,
  ...
  },
  {
    ...
    className: 'bottom-1/3 left-1/2 -translate-x-1/2 text-center w-[90%]',
  },
];
